...
## Project Structure
    ...
    ├── testapiautodatamod_112900  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_112900`
...
2. Clone this repo and `cd testapiautodatamod_112900`
